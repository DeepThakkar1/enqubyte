                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="file" name="photo" value="{{$employee->photo}}" class="form-control">
                                                @if($employee->photo)
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="file" name="verification_doc" value="{{$employee->verification_doc}}" class="form-control">
