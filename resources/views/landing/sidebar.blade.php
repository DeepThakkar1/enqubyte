        ...
        <div class="sidebar-widget-container">
            ...
            <div class="sidebar-textwidget">
                <div class="sidebar-logo-wraper">
                    <a href="/">
                        <img src="/img/logo.png" alt="sidebar logo" style="width: 200px;">
                    </a>
                </div>
                ...
                <ul class="sideabr-list-widget">
                    <li>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <p>Shradha Petrol Pump,<br>Flat No - 1,Grandueur Apartment in front of 3M car care,Near College road,Ramdas Colony,</p>
                                <span>Nashik,Maharastra,422005</span>
                            </div>
                        </div><!-- address 1 -->
                    </li>
                    <li>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="mailto:info@domain.com">work.trumpets@gmail.com</a>
                    ...
                    <li>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="tel:906-624-2565">9922367414</a>
