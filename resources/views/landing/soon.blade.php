        ...
        <div class="row home-banner-section">
            <div class="col-lg-7 align-self-center">
                <div class="agency-banner-content banner-style6">
                    ...
                    <a href="#explore" class="btn btn-outline-primary" >Explore More <i class="fa fa-arrow-down"></i></a>
...
<!-- growth grid section -->
<section id="explore" class="growth-card-section xs-section-padding custom-xs-section-padding">
    <div class="container">
        <div class="row">
...
<section class="section-padding-medium desktop-enquiries section-padding-medium1" style="padding-top: 0px;">
    <div class="container">
         <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="agency-section-title text-center style5">
                    <h2 class="main-title medium custom-main-title-heading">Why Enqubyte?</h2>
                </div><!-- .agency-section-title .style3 END -->
            </div>
        </div><!-- .row END -->   
        <div id="enquiries">
...
<section class="xs-section-padding-bottom gray-bg more-features-area" style="margin-top: 40px; padding-top: 45px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div class="agency-section-title text-center section-title-style2">                    
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="single-more-feauture text-center wow fadeIn" data-wow-delay=".2s">
                    ...
                    <h3 class="feature-title">No More Communication Barriers</h3>
                    <p>We work systematically to integrate corporate responsibility in our core business</p>
                </div><!-- .single-more-feauture END -->
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="single-more-feauture text-center wow fadeIn" data-wow-delay=".4s">
                    ...
                    <h3 class="feature-title">Cost Control and Savings</h3>
                    <p>We work systematically to integrate corporate responsibility in our core business</p>
                </div><!-- .single-more-feauture END -->
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="single-more-feauture text-center wow fadeIn" data-wow-delay=".6s">
                    ...
                    <h3 class="feature-title">Faster Completion of Tasks</h3>
                    <p>We work systematically to integrate corporate responsibility in our core business</p>
                </div><!-- .single-more-feauture END -->
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="single-more-feauture text-center wow fadeIn" data-wow-delay=".8s">
                    ...
                    <h3 class="feature-title">Better Planning/Reporting</h3>
                    <p>We work systematically to integrate corporate responsibility in our core business</p>
                </div><!-- .single-more-feauture END -->
            </div>
            <div class="col-md-6 col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="call-to-action text-center action-style2">
                        <h2 class="content-title">Subcribe now, and get notified when we are ready!</h2>
