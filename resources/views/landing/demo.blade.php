...
<!-- Mirrored from html.xpeedstudio.com/agmycoo/index-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Dec 2018 04:32:17 GMT -->
<head>
		<meta charset="utf-8">
		<meta http-equiv="x-ua-compatible" content="ie=edge">
		<title>Multipurpose - Agecny Index V2</title>
    ...
    <div class="container">
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="agency-banner-content banner-style3" style="margin-top: 100px;">
                        <h1 class="banner-title" style="color: #000;">Grow Your Business Using Agencify</h1>
                        <p style="color: #000;">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which </p>
                ...
                <div class="about-slider-wraper">
                    <div class="about-slider owl-carousel">
                        <div class="single-slider">
                            <img src="assets/images/about-slider/about-slider1.png" alt="">
                        </div>
                        <div class="single-slider">
                            <img src="assets/images/about-slider/about-slider2.png" alt="">
                        </div>
                        <div class="single-slider">
                            <img src="assets/images/about-slider/about-slider3.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="success-summary-image">
                    <img src="assets/images/success-summary-img.png" alt="">
                </div>
            </div>
        </div><!-- .row END -->
    </div><!-- .container END -->
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="agency-section-title text-center section-title-style2">                    
                    ...
                    <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                </div><!-- .agency-section-title .section-title-style2 END -->
            </div>
        </div><!-- .row end -->        
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single-funfact">
                    <div class="funfact-header">
                        <img src="assets/images/funfact/funfact-icon-1.png" alt="">
                    </div>
                    <span class="number-percentage-count number-percentage" data-value="25485" data-animation-duration="3500">0</span>
                    <p>Support Given</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-funfact">
                    <div class="funfact-header">
                        <img src="assets/images/funfact/funfact-icon-2.png" alt="">
                    </div>
                    <span class="number-percentage-count number-percentage" data-value="784" data-animation-duration="3500">0</span>
                    <p>Video Tutorial</p>
                </div><!-- .single-funfact END -->
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-funfact">
                    <div class="funfact-header">
                        <img src="assets/images/funfact/funfact-icon-3.png" alt="">
                    </div>
                    <span class="number-percentage-count number-percentage" data-value="35" data-animation-duration="3500">0</span><span>+</span>
                    <p>Expert Stuff</p>
                </div><!-- .single-funfact END -->
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-funfact">
                    <div class="funfact-header">
                        <img src="assets/images/funfact/funfact-icon-4.png" alt="">
                    </div>
                    <span class="number-percentage-count number-percentage" data-value="6548" data-animation-duration="3500">0</span>
                    <p>Expert Stuff</p>
                </div><!-- .single-funfact END -->
            </div>
        </div><!-- .row END -->
    </div><!-- .container END -->
</section><!-- funfact area section end -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-blog blog-style2">
                    <div class="post-image">
                        <img src="assets/images/blog/agency-blog-4.jpg" alt="">
                    </div><!-- .post-image end -->
                    <div class="post-body">
                        <div class="entry-header">
                            <div class="entry-meta">
                                <a href="#" class="post-cat gradient-title"><i class="icon icon-folder"></i> WEB DEVELOPMENT</a>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog blog-style2">
                    <div class="post-image">
                        <img src="assets/images/blog/agency-blog-5.jpg" alt="">
                    </div><!-- .post-image end -->
                    <div class="post-body">
                        <div class="entry-header">
                            <div class="entry-meta">
                                <a href="#" class="post-cat gradient-title"><i class="icon icon-folder"></i> IOS APPS</a>
                            </div>
                            <h4 class="entry-title">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-post-list">
                    <div class="single-blog blog-style2">
                        <div class="entry-header">
                            <div class="entry-meta">
                                <a href="#" class="post-cat gradient-title"><i class="icon icon-folder"></i> MARKETING</a>
                            </div>
                            <h4 class="entry-title">
                    ...
                    <div class="single-blog blog-style2">
                        <div class="entry-header">
                            <div class="entry-meta">
                                <a href="#" class="post-cat gradient-title"><i class="icon icon-folder"></i> FRONT END</a>
                            </div>
                            <h4 class="entry-title">
        ...
        <div class="btn-wraper text-center">
            <a href="news-list.html" class="btn btn-primary btn-gradient3 icon-right">VIEW ALL <i class="icon icon-arrow-right"></i></a>
        </div>
    </div><!-- .container END -->
</section><!-- agency media area section end -->

<!-- call to action section -->
<section class="calltoaction-area" style="background-image: url(assets/images/call-to-action.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="call-to-action text-center">
                    ...
                    <div class="btn-wraper">
                        <a href="#" class="btn btn-primary style2 icon-right">Hire us <i class="icon icon-arrow-right"></i></a>
...
<div class="agency_client_slider client-slider-style2 gray-bg">
    <div class="container">
        <div class="client-slider owl-carousel">
            ...
            <div class="item">
                <img src="assets/images/client/client-10.png" alt="">
            </div>
            <div class="item">
                <img src="assets/images/client/client-6.png" alt="">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="get-subscribe-image">
                    <img src="assets/images/getSubscribe-img.png" alt="">
                </div>
            </div>
        </div><!-- .row END -->
    </div><!-- .container END -->
					...
					<div class="row">
						<div class="col-md-6">
							<div class="copyright-section">
								<p>Copyright 2018, <a href="https://themeforest.net/user/xpeedstudio/portfolio">Agencify</a> All Rights Reserved.</p>
...
<!-- Mirrored from html.xpeedstudio.com/agmycoo/index-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Dec 2018 04:33:09 GMT -->
</html>